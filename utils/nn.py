...
#
#     def forward(self, r_score_p, r_score_n):
#
#         hinge_loss = 10 - r_score_p + r_score_n     # 10 is M in paper, hyperparameters
#         hinge_loss[hinge_loss < 0] = 0
#         return torch.Tensor(list(hinge_loss))
...
class MyHingeLoss(nn.Module):
  ...
  def forward(self, r_score_p,  r_score_n):
    hinge_loss = self.margin - r_score_p + r_score_n     # 10 is M in paper, hyperparameters
    hinge_loss[hinge_loss < 0] = 0
